...
for csv_file in csv_files:
    ...
    allowed_cols = [
        ...
        'Mem_Address','Mem_JoinDate','Mem_Class','Mem_HomePhone','Mem_Mobile','Mem_Receiver',
        'Mem_WorkPhone','Mem_Photo','Mem_Notes','Mem_LastPayedFees','Mem_Status',
        'MemCard_MemberName','MemCard_MemberJobTitle','Mem_GraduationDesc','Mem_Notes_2',
        'Mem_Notes_3','Mem_Notes_4','Mem_Relation','Mem_BoardDecision_Date','Mem_BoardDecision_Number',
    ...
    sql = f"INSERT INTO old_members ({cols}) VALUES ({vals})"
    ...
    cursor.close()
    conn.close()
    print(f"✅ تم رفع {csv_file} ({len(df)}) عضو")

print("جميع الملفات تم رفعها بنجاح إلى جدول old_members.")